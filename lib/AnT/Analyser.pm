...
AnT::Analyser - An object providing inheritable methods which allow
...
This is an abstract base class which provides various methods
which are inherited by objects which need to calculate various
statistics about themselves e.g. sequence composition,
molecular weight.
...
=head2 molwt
 ...
 Returns : Molecular weight as an integer
 Args    : None
...
sub is_dna_iupac
{
    ...
    $self->str =~ /[^acgtnmrwsykvhdbx]/i and return 0;
    return 1;
}
...
sub is_protein
{
    ...
    $self->str =~ /[^acdefghiklmnpqrstvwy\*]/i and return 0;
    return 1;
}
...
sub is_protein_ambig
{
    ...
    $self->str =~ /[^abcdefghiklmnpqrstvwxyz\*]/i and return 0;
    return 1;
}
